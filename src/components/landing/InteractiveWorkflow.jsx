  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        >
          <div className={`inline-flex flex-wrap justify-center rounded-full p-1.5 border ${theme === "dark" ? "bg-[#111111] border-white/10" : "bg-white border-gray-200 shadow-sm"
            }`}>
            {workflowSteps.map((step, index) => (
              <button
                key={step.id}
                onClick={() => setActiveStep(index)}
                className={`px-4 md:px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${activeStep === index
                  ? theme === "dark"
          ...
          >
            ...
            <div className="order-1 lg:order-2">
              ...
              >
                ...
                {/* App content mockup */}
                <div className={`aspect-[4/3] p-6 ${theme === "dark" ? "bg-[#0a0a0a]" : "bg-gray-50"
                  }`}>
                  {/* KPI mockup */}
                  {activeStep === 0 && (
                    <div className="h-full flex flex-col gap-4">
                      <div className="grid grid-cols-3 gap-3">
                        {[...Array(6)].map((_, i) => (
                          <div key={i} className={`rounded-lg p-3 ${theme === "dark" ? "bg-[#111111]" : "bg-white border border-gray-200"}`}>
                            <div className={`w-8 h-8 rounded-lg mb-2 ${theme === "dark" ? "bg-[#81E6D9]/20" : "bg-[#1a1a1a]"}`}></div>
                            <div className={`h-4 rounded w-16 mb-1 ${theme === "dark" ? "bg-white/10" : "bg-gray-100"}`}></div>
                            <div className={`h-6 rounded w-20 ${theme === "dark" ? "bg-[#81E6D9]/10" : "bg-gray-200"}`}></div>
                          </div>
                        ))}
                      </div>
                      <div className={`flex-1 rounded-lg p-4 flex items-end gap-2 ${theme === "dark" ? "bg-[#111111]" : "bg-white border border-gray-200"}`}>
                  ...
                  {activeStep === 1 && (
                    <div className="h-full flex flex-col">
                      <div className={`flex-1 rounded-lg p-4 flex flex-col gap-3 ${theme === "dark" ? "bg-[#111111]" : "bg-white border border-gray-200"}`}>
                        <div className="flex gap-3">
                          <div className={`w-8 h-8 rounded-full flex-shrink-0 ${theme === "dark" ? "bg-white/10" : "bg-gray-200"}`}></div>
                          <div className={`rounded-2xl rounded-tl-none p-3 max-w-[70%] ${theme === "dark" ? "bg-white/5" : "bg-gray-100"}`}>
                            <div className={`h-3 rounded w-full mb-2 ${theme === "dark" ? "bg-white/10" : "bg-gray-200"}`}></div>
                            <div className={`h-3 rounded w-3/4 ${theme === "dark" ? "bg-white/10" : "bg-gray-200"}`}></div>
                          </div>
                        </div>
                        <div className="flex gap-3 justify-end">
                          <div className={`rounded-2xl rounded-tr-none p-3 max-w-[70%] ${theme === "dark" ? "bg-[#81E6D9]/20" : "bg-[#1a1a1a]/10"}`}>
                            <div className={`h-3 rounded w-full mb-2 ${theme === "dark" ? "bg-[#81E6D9]/30" : "bg-[#1a1a1a]/20"}`}></div>
                            <div className={`h-3 rounded w-2/3 ${theme === "dark" ? "bg-[#81E6D9]/30" : "bg-[#1a1a1a]/20"}`}></div>
                          </div>
                          <div className={`w-8 h-8 rounded-full flex-shrink-0 ${theme === "dark" ? "bg-[#81E6D9]/50" : "bg-[#1a1a1a]"}`}></div>
                        </div>
                      </div>
                      <div className="mt-3 flex gap-2">
                        <div className={`flex-1 h-10 rounded-full ${theme === "dark" ? "bg-[#111111]" : "bg-gray-100"}`}></div>
                        <div className={`w-10 h-10 rounded-full ${theme === "dark" ? "bg-[#81E6D9]" : "bg-[#1a1a1a]"}`}></div>
                      </div>
                    </div>
                  )}
                  {/* Workbench mockup */}
                  {activeStep === 2 && (
                    <div className="h-full flex gap-4">
                      <div className={`w-48 rounded-lg p-3 ${theme === "dark" ? "bg-[#111111]" : "bg-white border border-gray-200"}`}>
                        <div className={`h-4 rounded w-20 mb-4 ${theme === "dark" ? "bg-white/10" : "bg-gray-100"}`}></div>
                        {[...Array(5)].map((_, i) => (
                          <div key={i} className={`h-8 rounded-lg mb-2 flex items-center gap-2 px-2 ${i === 1 ? (theme === "dark" ? "bg-[#81E6D9]/20" : "bg-[#1a1a1a]/10") : (theme === "dark" ? "bg-white/5" : "bg-gray-50")
                            }`}>
                            <div className={`w-4 h-4 rounded ${theme === "dark" ? "bg-white/10" : "bg-gray-200"}`}></div>
                            <div className={`h-3 flex-1 rounded ${theme === "dark" ? "bg-white/10" : "bg-gray-200"}`}></div>
                          </div>
                        ))}
                      </div>
                      <div className={`flex-1 rounded-lg p-4 ${theme === "dark" ? "bg-[#111111]" : "bg-white border border-gray-200"}`}>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {[...Array(4)].map((_, i) => (
                            <div key={i} className={`h-20 rounded-lg ${theme === "dark" ? "bg-white/5" : "bg-gray-50"}`}></div>
                          ))}
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Reports mockup */}
                  {activeStep === 3 && (
                    <div className={`h-full rounded-lg p-4 flex flex-col ${theme === "dark" ? "bg-[#111111]" : "bg-white border border-gray-200"}`}>
                      <div className="flex justify-between items-center mb-4">
                        <div className={`h-6 rounded w-40 ${theme === "dark" ? "bg-white/10" : "bg-gray-100"}`}></div>
                        <div className={`h-8 rounded-lg w-24 ${theme === "dark" ? "bg-[#81E6D9]" : "bg-[#1a1a1a]"}`}></div>
                      </div>
                      <div className={`flex-1 border-2 border-dashed rounded-lg p-4 ${theme === "dark" ? "border-white/10" : "border-gray-200"}`}>
                        <div className={`h-8 rounded w-full mb-3 ${theme === "dark" ? "bg-white/5" : "bg-gray-100"}`}></div>
                        <div className="space-y-2">
                          {[...Array(4)].map((_, i) => (
                            <div key={i} className={`h-4 rounded ${theme === "dark" ? "bg-white/5" : "bg-gray-50"}`} style={{ width: `${100 - i * 15}%` }}></div>
                          ))}
                        </div>
                      </div>
                    </div>
